...
<body>
    ...
    <script>
        ...
        // --- 3. D20 TEXTURE GENERATOR & MATERIALS ---
        // สร้าง Texture เก็บไว้ 20 ค่าสำหรับเลข 1 - 20
        const d20Textures = {};
        ...
        // Material พื้นฐานของ D20
        const d20Material = new THREE.MeshStandardMaterial({
            map: getOrCreateNumberTexture(20), // เริ่มต้นแสดงเลข 20
            roughness: 0.3,
            metalness: 0.4,
            flatShading: true
        });
        ...
        // Hitbox สำหรับเพิ่มขอบเขตการกดให้ใกล้มือยิ่งขึ้น
        ...
        // --- 8. DICE ROLLING LOGIC & RAYCASTING ---
        ...
        function rollDice() {
            ...
            let rollDuration = 1000; // เวลาหมุน 1 วินาที
            let startTime = Date.now();
            let finalValue = Math.floor(Math.random() * 20) + 1;

            // สุ่มเปลี่ยนเลขรัวๆ ขณะกำลังทอยเต๋า
            ...
            // เมื่อครบกำหนดเวลา หยุดสุ่มและแสดงเลขจริง
            setTimeout(() => {
        ...
        // เปลี่ยนรูป Cursor เมาส์เมื่อชี้โดนวัตถุที่กดได้
        ...
        function animate() {
            ...
            if (isRolling) {
                d20Group.rotation.x += 0.25;
                d20Group.rotation.y += 0.35;
                d20Group.rotation.z += 0.15;
            } else {
